...
public class BuyTicketsGUI extends JFrame {
	...
	private JButton btnBuy = new JButton(ResourceBundle.getBundle("Etiquetas").getString("BuyTickets"));
	...
	public BuyTicketsGUI(Vector<domain.Event> v) {
	...
	private void jbInit(Vector<domain.Event> v) throws Exception {
		...
		this.setTitle(ResourceBundle.getBundle("Etiquetas").getString("BuyTickets"));
		...
		btnBuy.setBounds(new Rectangle(100, 275, 130, 30));
		...
		this.getContentPane().add(btnBuy, null);
		...
		JLabel lblPrize = new JLabel(ResourceBundle.getBundle("Etiquetas").getString("Price")+": 20"); //$NON-NLS-1$ //$NON-NLS-2$
		lblPrize.setBounds(100, 247, 65, 13);
...
//			    		  Component o=(Component) jCalendar.getDayChooser().getDayPanel().getComponent(i+offset);; 
	...
	private void jButtonCreate_actionPerformed(ActionEvent e) {
		...
		try {
			...
			Ticket ti = facade.buyTicket(event, user);
			
			if(ti!=null) {
				jLabelMsg.setText("Ticket bought");
			}
			else
				jLabelMsg.setText("Couldn't buy ticket");
		} catch (Exception e1) {
